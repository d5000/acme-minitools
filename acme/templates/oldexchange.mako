...
<%def name="body()">
  <div class="ui container" style="margin:4.6em">
    ...
    <div class="ui header">Market data</div>
      <div id="myForm"></div>
  ...
  <script>
    ...
    ohlcSelection.append("g")
          .attr("class", "volume")
            ...
            .attr("transform", "translate(0," + dim.ohlc.height + 100 + ")");
    ...
    d3.csv("/css/novaohlc.csv", function(error, data) {
        ...
        // var trendlineData = [
        //     {start: {date: new Date(2014, 2, 11), value: 72.50},
        //      end: {date: new Date(2014, 5, 9), value: 63.34}},
        //     {start: {date: new Date(2013, 10, 21), value: 43},
        //      end: {date: new Date(2014, 2, 17), value: 70.50}}
        // ];

        // var supstanceData = [
        //     {start: new Date(2014, 2, 11),
        //      end: new Date(2014, 5, 9), value: 63.64},
        //     {start: new Date(2013, 10, 21),
        //      end: new Date(2014, 2, 17), value: 55.50}
        // ];
